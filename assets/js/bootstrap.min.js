(() => {
  ...
  var require_bootstrap_min = __commonJS({
    "node_modules/bootstrap/dist/js/bootstrap.min.js"(exports, module) {
      !function(t, e) {
        "object" == typeof exports && "undefined" != typeof module ? module.exports = e(require_popper()) : "function" == typeof define && define.amd ? define(["@popperjs/core"], e) : (t = "undefined" != typeof globalThis ? globalThis : t || self).bootstrap = e(t.Popper);
      }(exports, function(t) {
        "use strict";
        function e(t2) {
        ...
        class q {
          ...
          _mergeConfigObj(t2, e2) {
            ...
            return __spreadValues(__spreadValues(__spreadValues(__spreadValues({}, this.constructor.Default), "object" == typeof i2 ? i2 : {}), l(e2) ? B.getDataAttributes(e2) : {}), "object" == typeof t2 ? t2 : {});
          }
        ...
        class fe extends W {
          ...
          _getPopperConfig() {
            ...
            return (this._inNavbar || "static" === this._config.display) && (B.setDataAttribute(this._menu, "popper", "static"), t2.modifiers = [{ name: "applyStyles", enabled: false }]), __spreadValues(__spreadValues({}, t2), v(this._config.popperConfig, [t2]));
          }
        ...
        class Ni extends W {
          ...
          _getTemplateFactory(t2) {
            return this._templateFactory ? this._templateFactory.changeContent(t2) : this._templateFactory = new Ai(__spreadProps(__spreadValues({}, this._config), { content: t2, extraClass: this._resolvePossibleFunction(this._config.customClass) })), this._templateFactory;
          }
          ...
          _getPopperConfig(t2) {
            ...
            return __spreadValues(__spreadValues({}, e2), v(this._config.popperConfig, [e2]));
          }
          _setListeners() {
        ...
        b(Ni);
        const Pi = __spreadProps(__spreadValues({}, Ni.Default), { content: "", offset: [0, 8], placement: "right", template: '<div class="popover" role="tooltip"><div class="popover-arrow"></div><h3 class="popover-header"></h3><div class="popover-body"></div></div>', trigger: "click" }), xi = __spreadProps(__spreadValues({}, Ni.DefaultType), { content: "(null|string|element|function)" });
        class Mi extends Ni {
          static get Default() {
            return Pi;
          }
