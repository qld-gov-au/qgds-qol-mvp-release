...
`;var M=`<footer class="qld-footer {{variantClass}}" role="contentinfo">
    ...
    <div class="container">
        ...
        <div class="row {{#unless followlinksDisabled}}{{#if feedbackFormDisabled}}r25{{else}}r20{{/if}}{{else}}{{#if feedbackFormDisabled}}r33{{else}}r25{{/if}}{{/unless}}">
...
`;function o(C){C.registerPartial("accordion",n),C.registerPartial("banner",d),C.registerPartial("blockquote",c),C.registerPartial("breadcrumbs",f),C.registerPartial("breadcrumbsWrapper",p),C.registerPartial("button",u),C.registerPartial("callout",h),C.registerPartial("card",L),C.registerPartial("contentFooter",v),C.registerPartial("contentFooterWrapper",m),C.registerPartial("contentWrapper",g),C.registerPartial("correctincorrect",V),C.registerPartial("dateinput",H),C.registerPartial("footer",M),C.registerPartial("footerForgov",b),C.registerPartial("formcheck",Z),C.registerPartial("fullPage",_),C.registerPartial("globalAlert",w),C.registerPartial("head",q),C.registerPartial("header",x),C.registerPartial("inpageAlert",y),C.registerPartial("inpagenav",k),C.registerPartial("mainContainerWrapper",T),C.registerPartial("metaDcTerms",S),C.registerPartial("metaOpenGraph",R),C.registerPartial("modal",D),C.registerPartial("navbar",O),C.registerPartial("pagination",A),C.registerPartial("quickexit",P),C.registerPartial("searchInput",E),C.registerPartial("select",I),C.registerPartial("sidenav",N),C.registerPartial("sidenavWrapper",F),C.registerPartial("spinner",G),C.registerPartial("table",Q),C.registerPartial("tag",J),C.registerPartial("textarea",B),C.registerPartial("textbox",W),C.registerPartial("typography",Y),C.registerPartial("video",j)}typeof Handlebars!="undefined"&&o(Handlebars);var U=!1;function $(C){typeof C=="undefined"&&console.error("Handlebars.init requires HandleBars"),typeof C!="undefined"?(U?console.log("HandleBars Helpers And Partials already loaded, loading again"):U=!0,l(C),o(C)):console.log("Handlebars not found, init failed")}typeof Handlebars!="undefined"&&$(Handlebars);})();
