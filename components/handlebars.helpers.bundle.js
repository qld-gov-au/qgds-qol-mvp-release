...
(() => {
  ...
  function handlebarsHelpers(Handlebars2) {
    Handlebars2.registerHelper("contains", function(needle, haystack, options) {
      needle = Handlebars2.escapeExpression(needle);
      haystack = Handlebars2.escapeExpression(haystack);
      return haystack.indexOf(needle) > -1 ? options.fn(this) : options.inverse(this);
    });
    Handlebars2.registerHelper("ifCond", function(v1, operator, v2, options) {
      switch (operator) {
        case "==":
    ...
    Handlebars2.registerHelper("isMultipleOfThree", function(index) {
      return index % 3 === 0;
    });
    Handlebars2.registerHelper("isEndOfRow", function(index) {
      return (index + 1) % 3 === 0;
    });
  }
  ...
  var init = () => handlebarsHelpers(import_handlebars.default);
})();
