"use strict";(()=>{function l(C){C.registerHelper("contains",function(t,a,e){return t=C.escapeExpression(t),a=C.escapeExpression(a),a.indexOf(t)>-1?e.fn(this):e.inverse(this)}),C.registerHelper("ifCond",function(t,a,e,i){switch(a){case"==":return t==e?i.fn(this):i.inverse(this);case"===":return t===e?i.fn(this):i.inverse(this);case"!=":return t!=e?i.fn(this):i.inverse(this);case"!==":return t!==e?i.fn(this):i.inverse(this);case"<":return t<e?i.fn(this):i.inverse(this);case"<=":return t<=e?i.fn(this):i.inverse(this);case">":return t>e?i.fn(this):i.inverse(this);case">=":return t>=e?i.fn(this):i.inverse(this);case"&&":return t&&e?i.fn(this):i.inverse(this);case"||":return t||e?i.fn(this):i.inverse(this);case"contains":return typeof t=="string"&&typeof e=="string"?t.toLowerCase().indexOf(e.toLowerCase())>=0?i.fn(this):i.inverse(this):i.inverse(this);default:return i.inverse(this)}}),C.registerHelper("isType",function(t,a,e){return t===a?e.fn(this):e.inverse(this)}),C.registerHelper("ifAny",function(...t){let a=t.pop();return t.some(e=>!!e)?a.fn(this):a.inverse(this)}),C.registerHelper("formatDate",function(t,a){let e;if(t&&(e=new Date(t)),isNaN(e)&&a&&(e=new Date(a)),isNaN(e))return"Invalid Date";var i=["January","February","March","April","May","June","July","August","September","October","November","December"],Y=e.getDate(),z=i[e.getMonth()],$=e.getFullYear();return`${Y} ${z} ${$}`}),C.registerHelper("formatDateOrToday",function(t){let a=t||new Date().toISOString();return C.helpers.formatDate(a)})}typeof Handlebars!="undefined"&&l(Handlebars);var r=`<!-- QGDS Component: Accordion -->
...
</div>`;var n=`<!-- QGDS Component: Blockquote -->
...
</figure>`;var d=`<nav aria-label="breadcrumb">
    <ol class="breadcrumb">
        {{#each breadcrumbs}}
...
{{/unless }}`;var f=`<!-- QGDS Component: Callout -->
...
</dl>`;var L=`<div class="container qld-content-footer">
  <div class="row">
    {{> @partial-block }}
  </div>
...
`;var m="";var g=`<!-- QGDS Component: Date input -->
...
`;var V=`<footer class="qld-footer {{variantClass}}" role="contentinfo">
...
</footer>`;var H=`<footer class="qld-footer {{ variantClass }}" role="contentinfo">
...
</html>`;var b=`<!-- QGDS Component: Global Alert -->
...
`;var w=`<header class="qld__header" role="banner">
...
<!-- HEADER END -->`;var q=`<div class="alert {{variantClass}} {{customClass}}" role="alert">
    {{#if heading}}
    <div class="alert-heading" role="heading">{{{ heading }}}</div>
    {{/if}}
    {{{ content }}}
</div>`;var x=`<!-- QGDS Partial: inpage-nav -->
...
{{#if og.type }}<meta property="og:type" content="{{og.type}}" />{{/if}}`;var S=`<!-- Example button to trigger the modal -->
...
</div>`;var R=`<!-- QGDS Partial: Primary navigation -->
...
</nav>`;var O=`<!-- QGDS Component: Loading Quick exit -->
...
</div>`;var P=`<!-- QGDS Component: Select -->
...
`;var E=`<div class="qld-side-navigation">
...
`;var N=`<!-- QGDS Component: Loading Spinner -->
...
<input id="example-1" class="qld-text-input form-control {{customClass}} {{#if isFilled}}form-style-filled{{/if}}"
    ...
    isRequired}}required aria-required="true" {{/if}} />`;var B="<!-- QGDS Partial: typography -->";var W=`<!-- QGDS Component: Video -->
...
`;function o(C){C.registerPartial("accordion",r),C.registerPartial("banner",s),C.registerPartial("blockquote",n),C.registerPartial("breadcrumbs",d),C.registerPartial("breadcrumbsWrapper",c),C.registerPartial("button",p),C.registerPartial("callout",f),C.registerPartial("card",u),C.registerPartial("contentFooter",h),C.registerPartial("contentFooterWrapper",L),C.registerPartial("contentWrapper",v),C.registerPartial("correctincorrect",m),C.registerPartial("dateinput",g),C.registerPartial("footer",V),C.registerPartial("footerForgov",H),C.registerPartial("formcheck",M),C.registerPartial("fullPage",Z),C.registerPartial("globalAlert",b),C.registerPartial("head",_),C.registerPartial("header",w),C.registerPartial("inpageAlert",q),C.registerPartial("inpagenav",x),C.registerPartial("mainContainerWrapper",y),C.registerPartial("metaDcTerms",k),C.registerPartial("metaOpenGraph",T),C.registerPartial("modal",S),C.registerPartial("navbar",R),C.registerPartial("pagination",D),C.registerPartial("quickexit",O),C.registerPartial("searchInput",A),C.registerPartial("select",P),C.registerPartial("sidenav",E),C.registerPartial("sidenavWrapper",I),C.registerPartial("spinner",N),C.registerPartial("table",G),C.registerPartial("tag",F),C.registerPartial("textarea",Q),C.registerPartial("textbox",J),C.registerPartial("typography",B),C.registerPartial("video",W)}typeof Handlebars!="undefined"&&o(Handlebars);var j=!1;function U(C){typeof C=="undefined"&&console.error("Handlebars.init requires HandleBars"),typeof C!="undefined"?(j?console.log("HandleBars Helpers And Partials already loaded, loading again"):j=!0,l(C),o(C)):console.log("Handlebars not found, init failed")}typeof Handlebars!="undefined"&&U(Handlebars);})();
