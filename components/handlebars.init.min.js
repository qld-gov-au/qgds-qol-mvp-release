...
</footer>`;var M=`<footer class="qld-footer {{ variantClass }}" role="contentinfo">
...
</div>`;var E=`<!-- QGDS Component: Select -->
...
`;var P=`<div class="qld-side-navigation">
...
`;function o(C){C.registerPartial("accordion",r),C.registerPartial("banner",s),C.registerPartial("blockquote",n),C.registerPartial("breadcrumbs",d),C.registerPartial("breadcrumbsWrapper",c),C.registerPartial("button",p),C.registerPartial("callout",f),C.registerPartial("card",u),C.registerPartial("contentFooter",h),C.registerPartial("contentFooterWrapper",L),C.registerPartial("contentWrapper",v),C.registerPartial("correctincorrect",m),C.registerPartial("dateinput",g),C.registerPartial("footer",V),C.registerPartial("footerForgov",M),C.registerPartial("formcheck",H),C.registerPartial("fullPage",Z),C.registerPartial("globalAlert",b),C.registerPartial("head",_),C.registerPartial("header",w),C.registerPartial("inpageAlert",q),C.registerPartial("inpagenav",x),C.registerPartial("mainContainerWrapper",y),C.registerPartial("metaDcTerms",k),C.registerPartial("metaOpenGraph",T),C.registerPartial("modal",S),C.registerPartial("navbar",R),C.registerPartial("pagination",D),C.registerPartial("quickexit",O),C.registerPartial("searchInput",A),C.registerPartial("select",E),C.registerPartial("sidenav",P),C.registerPartial("sidenavWrapper",I),C.registerPartial("spinner",N),C.registerPartial("table",G),C.registerPartial("tag",F),C.registerPartial("textarea",Q),C.registerPartial("textbox",J),C.registerPartial("typography",B),C.registerPartial("video",W)}typeof Handlebars!="undefined"&&o(Handlebars);var j=!1;function U(C){typeof C=="undefined"&&console.error("Handlebars.init requires HandleBars"),typeof C!="undefined"?(j?console.log("HandleBars Helpers And Partials already loaded, loading again"):j=!0,l(C),o(C)):console.log("Handlebars not found, init failed")}typeof Handlebars!="undefined"&&U(Handlebars);})();
